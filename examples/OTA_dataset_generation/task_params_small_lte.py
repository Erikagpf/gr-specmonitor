...
toffset_range = [80]#[int(i) for i in np.linspace(50,10000,10)]#[50,60,70,80,90,100]
...
RF_params = [
    ('tx_gain_norm', [0.5]),#[0.4,0.5,0.6,0.7,0.8,0.9,0.99,0.2,0.3]),#10.0**np.arange(-20,0,5)),#range(0, 21, 10)),  #range(0,30,15)),
    ('settle_time', 0.25),
